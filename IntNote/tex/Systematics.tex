...
\centering
\includegraphics[width=1.0\textwidth]%
{figures/AllFigs/can_yields_TrigEffV2_YieldType0_Tight_pTBar_GT5_EffCor}
\caption{
Same as Figure~\ref{fig:SystEfficiency} but for the Trigger Efficiency uncertainty.
}
\label{fig:SystEfficiencyTrig}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1.0\textwidth]%
{figures/AllFigs/can_yields_TrigEffV2_YieldType5_Tight_pTBar_GT5_EffCor}
\caption{
Same as Figure~\ref{fig:SystEfficiencyTrig} but for the $\Gamma$.
}
\label{fig:SystEfficiencyTrigTau}
\end{figure}
...
Systematic uncertainties in the efficiencies thus result in uncertainties
...
The effect of the reconstruction efficiency uncertainties on the
  measurements is determined by varying the muon reconstrution 
...
The systematic uncertainties are taken From Ref.~\cite{Rel21Uncertainties}.
Figures~\ref{fig:SystEfficiency} and~\ref{fig:SystEfficiencyTau} 
  show the variations in the measured 
  widths and $\Gamma$, respectively, arising from the reconstruction efficiency uncertainties.
Figures~\ref{fig:SystEfficiencyTrig} and~\ref{fig:SystEfficiencyTrigTau}
  show the uncertainties arising from the Trigger efficiency uncertainties (taken from Ref.\cite{HION-2020-10}).
...
\centering
\includegraphics[width=1.0\textwidth,bb=0bp  140bp 570bp 280bp,clip]%
{figures/AllFigs/can_yields_TrigDep_YieldType5_Tight_pTBar_GT5_EffCor}
\caption{
...
\hline
Working point         & 2       & 0.5     & 0.5     \\
Efficiency            & 0.1     & 0.1     & 0.1 \\
$\Deta$ cut           & 0.5     & $\sim0$ & 0.25     \\
Fit-Model             & $\sim0$ & 2.0     & 0.75 \\ 
Higher order $\vn$    & 1.5     & 1       & 1       \\
$\Mmumu$ correction   & -       & $\sim0$ & $\sim0$ \\
Drell-Yan correction  & -       & 0.5     & 0.3     \\
\hline
\end{tabular}
\caption{
...
Source & \multicolumn{3}{ c|}{Uncertainty [\%]}   \\
\hline
Working point        & 4.5     & 0.5     & 1.5     \\
Efficiency           & 0.2     & 0.2     & 0.2     \\
$\Deta$ cut          & 1       & 0.5     & 0.5     \\
Higher order $\vn$   & 3.5     & 2       & 2       \\
$\Mmumu$ correction  & -       & $\sim0$ & $\sim0$ \\%TODO
Drell-Yan correction & -       & 1       & 0.7     \\
\hline
\end{tabular}
\caption{

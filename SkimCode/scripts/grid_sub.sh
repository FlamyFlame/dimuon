...
pathena TrigRates.py \
        --inDsTxt InDstxt_PP2024_5p36TeV.txt \
        --outDS user.yuhang.TrigRates.dimuon.pp2024data.Nov2024.1. \
...
#2024 PbPb data
# pathena TrigRates.py \
#         --inDS data24_hi.physics_HardProbes.OpenEnded.AOD.t0pro41_v01 \
#         --outDS user.yuhang.TrigRates.dimuon.PbPb2024data.Nov2024.1. \
#         --excludeFile=myfile.root \
#         --excludeFile=clean.sh \
#         --excludeFile=vim_backup

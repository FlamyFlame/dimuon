#ifndef __MCsingleCHadrNTupleFirstPass_C__
#define __MCsingleCHadrNTupleFirstPass_C__

#include "MCsingleCHadrNTupleFirstPass.h"
#include "Riostream.h"
...
bool MCsingleCHadrNTupleFirstPass::PassCuts(){
...
bool MCsingleCHadrNTupleFirstPass::IsResonance(){
...
bool MCsingleCHadrNTupleFirstPass::IsPhotoProduction(){
...
int MCsingleCHadrNTupleFirstPass::ParentGrouping(std::vector<int>& parent_ids, bool c_tag, bool prev_is_lepton){
...
void MCsingleCHadrNTupleFirstPass::GetPtEtaPhiFromBarcode(int barcode, std::vector<float>* pt_eta_phi){
...
int MCsingleCHadrNTupleFirstPass::UpdateCurParents(bool isMuon1, std::vector<int>& cur_prt_bars, std::vector<int>& cur_prt_ids, int hf_quark_index = -1){
...
int MCsingleCHadrNTupleFirstPass::FindHeavyQuarks(std::vector<int>& cur_prt_ids, int quark_type, bool isMuon1, int hadron_child_id = 0){
...
void MCsingleCHadrNTupleFirstPass::SingleMuonAncestorTracing(bool isMuon1){
...
int MCsingleCHadrNTupleFirstPass::AncestorGrouping(std::vector<int>& ancestor_ids){
  // incoming
...
void MCsingleCHadrNTupleFirstPass::HardScatteringAnalysis(std::vector<int>& ancestor_bars, std::vector<int>& ancestor_ids, int sign_dphi_mode, int ancestor_grp){
...
void MCsingleCHadrNTupleFirstPass::PrintHistory(std::ostream* f, bool print_single, bool muon1_sameancestor){
...
// void MCsingleCHadrNTupleFirstPass::SameSignSameAncestorsAnalysis(bool near_side, bool one_b_one_btoc, bool print_history = false){
...
void MCsingleCHadrNTupleFirstPass::MuonPairTagsReinit(){
  m1_c_tag = false;
  m2_c_tag = false;
  m1_osc = false;
  m2_osc = false;
...
void MCsingleCHadrNTupleFirstPass::CheckIfFromSameB(){
...
void MCsingleCHadrNTupleFirstPass::MuonPairAncestorTracing(){
...
void MCsingleCHadrNTupleFirstPass::KinematicCorrPlots(int isign, int idphi){
...
void MCsingleCHadrNTupleFirstPass::FillMuonPairTree(){
...
void MCsingleCHadrNTupleFirstPass::ProcessData(){
...
void MCsingleCHadrNTupleFirstPass::HistAdjust(){
...
void MCsingleCHadrNTupleFirstPass::Run(){
  clock_t start, end;

...
// void RDFBasedMuonPairPlotting::FillSingleHist1D(const Hist1DInfo * h1d, std::string hist_name_base, ROOT::RDF::RNode df_filtered, bool gapphoto, bool isRVec){
	...
	if (gapphoto){
		if (h1d->xaxis.bin_edges == nullptr){
			...
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.min, h1d->xaxis.max}, h1d->var_expr, "weight"));
			...
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Filter(RDFBasedMuonPairPlotting::BothMuonPassGapCuts, {"m1.eta", "m1.pt", "m1.charge", "m2.eta", "m2.pt", "m2.charge"}).Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.min, h1d->xaxis.max}, h1d->var_expr, "weight"));
			...
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Filter(RDFBasedMuonPairPlotting::PhotoProductionCut, {"asym", "acop"}).Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.min, h1d->xaxis.max}, h1d->var_expr, "weight"));
			...
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Filter(RDFBasedMuonPairPlotting::PhotoProductionCut, {"asym", "acop"}).Filter(RDFBasedMuonPairPlotting::BothMuonPassGapCuts, {"m1.eta", "m1.pt", "m1.charge", "m2.eta", "m2.pt", "m2.charge"}).Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.min, h1d->xaxis.max}, h1d->var_expr, "weight"));
			...
			std::cout << "*********************************************" << std::endl;
			hist_name = hist_name_base + pms.photocut_labels[0] + pms.gapcut_labels[0];
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.bin_edges}, h1d->var_expr, "weight"));
			hist_name = hist_name_base + pms.photocut_labels[0] + pms.gapcut_labels[1];
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Filter(RDFBasedMuonPairPlotting::BothMuonPassGapCuts, {"m1.eta", "m1.pt", "m1.charge", "m2.eta", "m2.pt", "m2.charge"}).Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.bin_edges}, h1d->var_expr, "weight"));
			hist_name = hist_name_base + pms.photocut_labels[1] + pms.gapcut_labels[0];
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Filter(RDFBasedMuonPairPlotting::PhotoProductionCut, {"asym", "acop"}).Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.bin_edges}, h1d->var_expr, "weight"));
			hist_name = hist_name_base + pms.photocut_labels[1] + pms.gapcut_labels[1];
			hist1d_rresultptrs_cur_file->push_back(df_filtered.Filter(RDFBasedMuonPairPlotting::PhotoProductionCut, {"asym", "acop"}).Filter(RDFBasedMuonPairPlotting::BothMuonPassGapCuts, {"m1.eta", "m1.pt", "m1.charge", "m2.eta", "m2.pt", "m2.charge"}).Histo1D<float, double>({hist_name.c_str(), h1d->hist1d_titles.c_str(), h1d->xaxis.nbins, h1d->xaxis.bin_edges}, h1d->var_expr, "weight"));
		}
	}else{

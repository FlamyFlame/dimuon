...
void RDFBasedHistFillingPP::FillHistograms(){
...
void RDFBasedHistFillingPP::HistPostProcess(){
...
void RDFBasedHistFillingPP::MakeAndWriteSingleMuonPtTrigEffGraphs(){
    ...
    for (std::string sign : {"_sign1", "_sign2"}){
        TH2D* h_pt2nd_vs_q_eta2nd_mu4_mu4noL1_sepr  = map_at_checked(hist2D_map, "h_pt2nd_vs_q_eta2nd" + sign + "_mu4_mu4noL1_sepr",    Form("MakeAndWriteSingleMuonPtTrigEffGraphs: hist2D_map.at(%s)", ("h_pt2nd_vs_q_eta2nd" + sign + "_mu4_mu4noL1_sepr").c_str()));
        TH2D* h_pt2nd_vs_q_eta2nd_mu4_sepr          = map_at_checked(hist2D_map, "h_pt2nd_vs_q_eta2nd" + sign + "_mu4_sepr",            Form("MakeAndWriteSingleMuonPtTrigEffGraphs: hist2D_map.at(%s)", ("h_pt2nd_vs_q_eta2nd" + sign + "_mu4_sepr").c_str()));
        TH2D* h_pt2nd_vs_q_eta2nd_2mu4_sepr         = map_at_checked(hist2D_map, "h_pt2nd_vs_q_eta2nd" + sign + "_2mu4_sepr",           Form("MakeAndWriteSingleMuonPtTrigEffGraphs: hist2D_map.at(%s)", ("h_pt2nd_vs_q_eta2nd" + sign + "_2mu4_sepr").c_str()));

...
cd "${SCRIPT_DIR}"
echo "[RUN] pbpb25 low-mass template-fit pass (trigger_mode=1, _no_res_cut)..."
root -l -b <<ROOTEOF
...
pbpb.Run();
std::cout << "\\n[RUN] pbpb25 template-fit completed successfully!" << std::endl;
.q
ROOTEOF
echo "[RUN] pbpb25 template-fit completed. Output file:"

...
void MuonPairPlottingPP::InitHists(){
    ...
    h_DR_zoomin_vs_pt2nd_mu4_w_single_b_sig_sel = new TH2D("h_DR_zoomin_vs_pt2nd_mu4_w_single_b_sig_sel",";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8);
    h_DR_0_2_mu4_w_single_b_sig_sel = new TH1D("h_DR_0_2_mu4_w_single_b_sig_sel",";#DeltaR;",20,0,0.2);
    h_DR_0_2_vs_pt2nd_mu4_w_single_b_sig_sel = new TH2D("h_DR_0_2_vs_pt2nd_mu4_w_single_b_sig_sel",";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), 20,0,0.2);
    ...
    h_pt2nd_mu4_w_single_b_sig_sel = new TH1D("h_pt2nd_mu4_w_single_b_sig_sel",";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    h_pt2nd_vs_q_eta_2nd_mu4_w_single_b_sig_sel = new TH2D("h_pt2nd_vs_q_eta_2nd_mu4_w_single_b_sig_sel",";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    ...
    h_DR_zoomin_vs_pt2nd_mu4_mu4noL1_w_single_b_sig_sel = new TH2D("h_DR_zoomin_vs_pt2nd_mu4_mu4noL1_w_single_b_sig_sel",";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8);
    h_DR_0_2_mu4_mu4noL1_w_single_b_sig_sel = new TH1D("h_DR_0_2_mu4_mu4noL1_w_single_b_sig_sel",";#DeltaR;",20,0,0.2);
    h_DR_0_2_vs_pt2nd_mu4_mu4noL1_w_single_b_sig_sel = new TH2D("h_DR_0_2_vs_pt2nd_mu4_mu4noL1_w_single_b_sig_sel",";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), 20,0,0.2);
    ...
    h_pt2nd_mu4_mu4noL1_w_single_b_sig_sel = new TH1D("h_pt2nd_mu4_mu4noL1_w_single_b_sig_sel",";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_w_single_b_sig_sel = new TH2D("h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_w_single_b_sig_sel",";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    ...
    h_pt2nd_mu4_mu4noL1_excl_w_single_b_sig_sel = new TH1D("h_pt2nd_mu4_mu4noL1_excl_w_single_b_sig_sel",";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_excl_w_single_b_sig_sel = new TH2D("h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_excl_w_single_b_sig_sel",";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    ...
    h_DR_zoomin_vs_pt2nd_2mu4_w_single_b_sig_sel = new TH2D("h_DR_zoomin_vs_pt2nd_2mu4_w_single_b_sig_sel",";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8);
    h_DR_0_2_2mu4_w_single_b_sig_sel = new TH1D("h_DR_0_2_2mu4_w_single_b_sig_sel",";#DeltaR;",20,0,0.2);
    h_DR_0_2_vs_pt2nd_2mu4_w_single_b_sig_sel = new TH2D("h_DR_0_2_vs_pt2nd_2mu4_w_single_b_sig_sel",";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), 20,0,0.2);
    ...
    h_pt2nd_2mu4_w_single_b_sig_sel = new TH1D("h_pt2nd_2mu4_w_single_b_sig_sel",";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    h_pt2nd_vs_q_eta_2nd_2mu4_w_single_b_sig_sel = new TH2D("h_pt2nd_vs_q_eta_2nd_2mu4_w_single_b_sig_sel",";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
    ...
    for (unsigned int isign = 0; isign < ParamsSet::nSigns; isign++){
        ...
        h_DR_zoomin_vs_pt2nd_mu4[isign] = new TH2D(Form("h_DR_zoomin_vs_pt2nd_mu4_sign%d",isign+1),";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8);
        h_DR_0_2_mu4[isign] = new TH1D(Form("h_DR_0_2_mu4_sign%d",isign+1),";#DeltaR;",20,0,0.2);
        h_DR_0_2_vs_pt2nd_mu4[isign] = new TH2D(Form("h_DR_0_2_vs_pt2nd_mu4_sign%d",isign+1),";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), 20,0,0.2);
        ...
        h_pt2nd_vs_phi2nd_mu4[isign] = new TH2D(Form("h_pt2nd_vs_phi2nd_mu4_sign%d",isign+1),";#phi;p_{T} [GeV]",nDphi_bins_trig_effcy,-pms.PI,pms.PI,int(pms.pT_bins_40.size())-1,pms.pT_bins_40.data());
        ...
        h_DR_zoomin_vs_pt2nd_mu4_mu4noL1[isign] = new TH2D(Form("h_DR_zoomin_vs_pt2nd_mu4_mu4noL1_sign%d",isign+1),";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8);
        h_DR_0_2_mu4_mu4noL1[isign] = new TH1D(Form("h_DR_0_2_mu4_mu4noL1_sign%d",isign+1),";#DeltaR;",20,0,0.2);
        h_DR_0_2_vs_pt2nd_mu4_mu4noL1[isign] = new TH2D(Form("h_DR_0_2_vs_pt2nd_mu4_mu4noL1_sign%d",isign+1),";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), 20,0,0.2);
        ...
        h_pt2nd_mu4_mu4noL1[isign] = new TH1D(Form("h_pt2nd_mu4_mu4noL1_sign%d",isign+1),";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1[isign] = new TH2D(Form("h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_sign%d",isign+1),";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pt2nd_vs_phi2nd_mu4_mu4noL1[isign] = new TH2D(Form("h_pt2nd_vs_phi2nd_mu4_mu4noL1_sign%d",isign+1),";#phi;p_{T} [GeV]",nDphi_bins_trig_effcy,-pms.PI,pms.PI,int(pms.pT_bins_40.size())-1,pms.pT_bins_40.data());
        ...
        h_pt2nd_mu4_mu4noL1_excl[isign] = new TH1D(Form("h_pt2nd_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_excl_sign%d",isign+1),";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_DR_zoomin_vs_pt2nd_2mu4[isign] = new TH2D(Form("h_DR_zoomin_vs_pt2nd_2mu4_sign%d",isign+1),";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8);
        h_DR_0_2_2mu4[isign] = new TH1D(Form("h_DR_0_2_2mu4_sign%d",isign+1),";#DeltaR;",20,0,0.2);
        h_DR_0_2_vs_pt2nd_2mu4[isign] = new TH2D(Form("h_DR_0_2_vs_pt2nd_2mu4_sign%d",isign+1),";p_{T,2nd} [GeV];#DeltaR",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), 20,0,0.2);
        ...
        h_pt2nd_2mu4[isign] = new TH1D(Form("h_pt2nd_2mu4_sign%d",isign+1),";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        h_pt2nd_vs_q_eta_2nd_2mu4[isign] = new TH2D(Form("h_pt2nd_vs_q_eta_2nd_2mu4_sign%d",isign+1),";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pt2nd_vs_phi2nd_2mu4[isign] = new TH2D(Form("h_pt2nd_vs_phi2nd_2mu4_sign%d",isign+1),";#phi;p_{T} [GeV]",nDphi_bins_trig_effcy,-pms.PI,pms.PI,int(pms.pT_bins_40.size())-1,pms.pT_bins_40.data());
        ...
        // pair kinematics requiring only single mu4 trigger
        h_Deta_vs_pT_1st_mu4[isign] = new TH2D(Form("h_Deta_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  nDeta_bins_trig_effcy,-4.8,4.8);
        h_Deta_zoomin_vs_pT_1st_mu4[isign] = new TH2D(Form("h_Deta_zoomin_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8);
        h_Dphi_vs_pT_1st_mu4[isign] = new TH2D(Form("h_Dphi_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  nDphi_bins_trig_effcy,-pms.PI,pms.PI);
        h_Dphi_zoomin_vs_pT_1st_mu4[isign] = new TH2D(Form("h_Dphi_zoomin_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8);
        h_DR_vs_pT_1st_mu4[isign] = new TH2D(Form("h_DR_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  nDR_bins_trig_effcy,0,pms.deltaR_thrsh[2]);
        h_DR_zoomin_vs_pT_1st_mu4[isign] = new TH2D(Form("h_DR_zoomin_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8);
        h_minv_zoomin_vs_pT_1st_mu4[isign] = new TH2D(Form("h_minv_zoomin_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];m_{#mu#mu} [GeV];",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  nminv_bins_trig_effcy,0,3.);
        h_pair_pt_log_vs_pT_1st_mu4[isign] = new TH2D(Form("h_pair_pt_log_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];p_{T}^{pair} [GeV];",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  int(pms.pT_bins_80.size() - 1), pms.pT_bins_80.data());
        h_pt2nd_vs_pT_1st_mu4[isign] = new TH2D(Form("h_pt2nd_vs_pT_1st_mu4_sign%d",isign+1),";p_{T,1st} [GeV];p_{T,2nd} [GeV];",  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_pt2nd_vs_pair_pT_mu4[isign] = new TH2D(Form("h_pt2nd_vs_pair_pT_mu4_sign%d",isign+1),";p_{T}^{pair} [GeV];p_{T,2nd} [GeV];", int(pms.pT_bins_80.size() - 1), pms.pT_bins_80.data(), int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        // pair kinematics requiring mu4_mu4noL1 trigger
        h_Deta_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_Deta_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",nDeta_bins_trig_effcy,-4.8,4.8, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Deta_zoomin_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_Deta_zoomin_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Dphi_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_Dphi_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",nDphi_bins_trig_effcy,-pms.PI,pms.PI, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Dphi_zoomin_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_Dphi_zoomin_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_DR_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_DR_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",nDR_bins_trig_effcy,0,pms.deltaR_thrsh[2], int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_DR_zoomin_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_DR_zoomin_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_minv_zoomin_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_minv_zoomin_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];m_{#mu#mu} [GeV];",nminv_bins_trig_effcy,0,3., int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pair_pt_log_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_pair_pt_log_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];p_{T}^{pair} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pt2nd_vs_pT_1st_mu4_mu4noL1[isign] = new TH2D(Form("h_pt2nd_vs_pT_1st_mu4_mu4noL1_sign%d",isign+1),";p_{T,1st} [GeV];p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_pt2nd_vs_pair_pT_mu4_mu4noL1[isign] = new TH2D(Form("h_pt2nd_vs_pair_pT_mu4_mu4noL1_sign%d",isign+1),";p_{T}^{pair} [GeV];p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), int(pms.pT_bins_80.size() - 1), pms.pT_bins_80.data());

        h_Deta_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_Deta_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",nDeta_bins_trig_effcy,-4.8,4.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Deta_zoomin_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_Deta_zoomin_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Dphi_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_Dphi_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",nDphi_bins_trig_effcy,-pms.PI,pms.PI,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Dphi_zoomin_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_Dphi_zoomin_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_DR_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_DR_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",nDR_bins_trig_effcy,0,pms.deltaR_thrsh[2],  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_DR_zoomin_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_DR_zoomin_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_minv_zoomin_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_minv_zoomin_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];m_{#mu#mu} [GeV];",nminv_bins_trig_effcy,0,3.,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pair_pt_log_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_pair_pt_log_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];p_{T}^{pair} [GeV];",int(pms.pT_bins_80.size() - 1), pms.pT_bins_80.data(),  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pt2nd_vs_pT_1st_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_pt2nd_vs_pT_1st_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T,1st} [GeV];p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_pt2nd_vs_pair_pT_mu4_mu4noL1_excl[isign] = new TH2D(Form("h_pt2nd_vs_pair_pT_mu4_mu4noL1_excl_sign%d",isign+1),";p_{T}^{pair} [GeV];p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  int(pms.pT_bins_80.size() - 1), pms.pT_bins_80.data());

        // pair kinematics requiring 2mu4 trigger
        h_Deta_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_Deta_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",nDeta_bins_trig_effcy,-4.8,4.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Deta_zoomin_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_Deta_zoomin_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#eta;",nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Dphi_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_Dphi_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",nDphi_bins_trig_effcy,-pms.PI,pms.PI,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_Dphi_zoomin_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_Dphi_zoomin_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];#Delta#phi;",nDR_deta_dphi_zoomin_bins_trig_effcy,-0.8,0.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_DR_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_DR_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",nDR_bins_trig_effcy,0,pms.deltaR_thrsh[2],  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_DR_zoomin_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_DR_zoomin_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];#DeltaR;",nDR_deta_dphi_zoomin_bins_trig_effcy,0,0.8,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_minv_zoomin_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_minv_zoomin_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];m_{#mu#mu} [GeV];",nminv_bins_trig_effcy,0,3.,  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pair_pt_log_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_pair_pt_log_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];p_{T}^{pair} [GeV];",int(pms.pT_bins_80.size() - 1), pms.pT_bins_80.data(),  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        h_pt2nd_vs_pT_1st_2mu4[isign] = new TH2D(Form("h_pt2nd_vs_pT_1st_2mu4_sign%d",isign+1),";p_{T,1st} [GeV];p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(),  int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_pt2nd_vs_pair_pT_2mu4[isign] = new TH2D(Form("h_pt2nd_vs_pair_pT_2mu4_sign%d",isign+1),";p_{T}^{pair} [GeV];p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data(), int(pms.pT_bins_80.size() - 1), pms.pT_bins_80.data());
        ...
        h_pt2nd_mu4_sepr[isign] = new TH1D(Form("h_pt2nd_mu4_sepr_sign%d",isign+1),";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        h_pt2nd_vs_q_eta_2nd_mu4_sepr[isign] = new TH2D(Form("h_pt2nd_vs_q_eta_2nd_mu4_sepr_sign%d",isign+1),";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_pt2nd_mu4_mu4noL1_sepr[isign] = new TH1D(Form("h_pt2nd_mu4_mu4noL1_sepr_sign%d",isign+1),";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_sepr[isign] = new TH2D(Form("h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_sepr_sign%d",isign+1),";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_pt2nd_mu4_mu4noL1_excl_sepr[isign] = new TH1D(Form("h_pt2nd_mu4_mu4noL1_excl_sepr_sign%d",isign+1),";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_excl_sepr[isign] = new TH2D(Form("h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_excl_sepr_sign%d",isign+1),";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
        ...
        h_pt2nd_2mu4_sepr[isign] = new TH1D(Form("h_pt2nd_2mu4_sepr_sign%d",isign+1),";p_{T,2nd} [GeV];",int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());

        h_pt2nd_vs_q_eta_2nd_2mu4_sepr[isign] = new TH2D(Form("h_pt2nd_vs_q_eta_2nd_2mu4_sepr_sign%d",isign+1),";q*#eta;p_{T} [GeV]",neta_bins_trig_effcy,-2.4,2.4, int(pms.pT_bins_40.size() - 1), pms.pT_bins_40.data());
...
void MuonPairPlottingPP::CalculateTrigEffcyRatio(){
    // for (int isign = 0; isign < ParamsSet::nSigns; isign++){
    //     h_Deta_mu4_mu4noL1[isign]->Divide(h_Deta_mu4[isign]);
    //     h_Deta_zoomin_mu4_mu4noL1[isign]->Divide(h_Deta_zoomin_mu4[isign]);
    //     h_Dphi_mu4_mu4noL1[isign]->Divide(h_Dphi_mu4[isign]);
    //     h_Dphi_zoomin_mu4_mu4noL1[isign]->Divide(h_Dphi_zoomin_mu4[isign]);
    //     h_DR_mu4_mu4noL1[isign]->Divide(h_DR_mu4[isign]);
    //     h_DR_zoomin_mu4_mu4noL1[isign]->Divide(h_DR_zoomin_mu4[isign]);
    //     h_pt2nd_mu4_mu4noL1[isign]->Divide(h_pt2nd_mu4[isign]);
    //     h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1[isign]->Divide(h_pt2nd_vs_q_eta_2nd_mu4[isign]);
    //     h_pair_eta_vs_pair_pT_mu4_mu4noL1[isign]->Divide(h_pair_eta_vs_pair_pT_mu4[isign]);
    //     h_Deta_Dphi_mu4_mu4noL1[isign]->Divide(h_Deta_Dphi_mu4[isign]);
    //     h_eta1_eta2_mu4_mu4noL1[isign]->Divide(h_eta1_eta2_mu4[isign]);
    //     h_eta_avg_Deta_mu4_mu4noL1[isign]->Divide(h_eta_avg_Deta_mu4[isign]);
    //     h_eta_avg_Dphi_mu4_mu4noL1[isign]->Divide(h_eta_avg_Dphi_mu4[isign]);
    //     h_minv_zoomin_mu4_mu4noL1[isign]->Divide(h_minv_zoomin_mu4[isign]);
    //     h_pair_pt_log_mu4_mu4noL1[isign]->Divide(h_pair_pt_log_mu4[isign]);
    //     h_minv_pair_pt_log_mu4_mu4noL1[isign]->Divide(h_minv_pair_pt_log_mu4[isign]);

    //     h_Deta_2mu4[isign]->Divide(h_Deta_mu4[isign]);
    //     h_Deta_zoomin_2mu4[isign]->Divide(h_Deta_zoomin_mu4[isign]);
    //     h_Dphi_2mu4[isign]->Divide(h_Dphi_mu4[isign]);
    //     h_Dphi_zoomin_2mu4[isign]->Divide(h_Dphi_zoomin_mu4[isign]);
    //     h_DR_2mu4[isign]->Divide(h_DR_mu4[isign]);
    //     h_DR_zoomin_2mu4[isign]->Divide(h_DR_zoomin_mu4[isign]);
    //     h_pt2nd_2mu4[isign]->Divide(h_pt2nd_mu4[isign]);
    //     h_pt2nd_vs_q_eta_2nd_2mu4[isign]->Divide(h_pt2nd_vs_q_eta_2nd_mu4[isign]);
    //     h_pair_eta_vs_pair_pT_2mu4[isign]->Divide(h_pair_eta_vs_pair_pT_mu4[isign]);
    //     h_Deta_Dphi_2mu4[isign]->Divide(h_Deta_Dphi_mu4[isign]);
    //     h_eta1_eta2_2mu4[isign]->Divide(h_eta1_eta2_mu4[isign]);
    //     h_eta_avg_Deta_2mu4[isign]->Divide(h_eta_avg_Deta_mu4[isign]);
    //     h_eta_avg_Dphi_2mu4[isign]->Divide(h_eta_avg_Dphi_mu4[isign]);
    //     h_minv_zoomin_2mu4[isign]->Divide(h_minv_zoomin_mu4[isign]);
    //     h_pair_pt_log_2mu4[isign]->Divide(h_pair_pt_log_mu4[isign]);
    //     h_minv_pair_pt_log_2mu4[isign]->Divide(h_minv_pair_pt_log_mu4[isign]);

    //     h_Deta_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_Deta_mu4_w_single_b_sig_sel[isign]);
    //     h_Deta_zoomin_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_Deta_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_Dphi_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_Dphi_mu4_w_single_b_sig_sel[isign]);
    //     h_Dphi_zoomin_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_Dphi_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_DR_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_DR_mu4_w_single_b_sig_sel[isign]);
    //     h_DR_zoomin_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_DR_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_pt2nd_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_pt2nd_mu4_w_single_b_sig_sel[isign]);
    //     h_pt2nd_vs_q_eta_2nd_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_pt2nd_vs_q_eta_2nd_mu4_w_single_b_sig_sel[isign]);
    //     h_pair_eta_vs_pair_pT_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_pair_eta_vs_pair_pT_mu4_w_single_b_sig_sel[isign]);
    //     h_Deta_Dphi_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_Deta_Dphi_mu4_w_single_b_sig_sel[isign]);
    //     h_eta1_eta2_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_eta1_eta2_mu4_w_single_b_sig_sel[isign]);
    //     h_eta_avg_Deta_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_eta_avg_Deta_mu4_w_single_b_sig_sel[isign]);
    //     h_eta_avg_Dphi_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_eta_avg_Dphi_mu4_w_single_b_sig_sel[isign]);
    //     h_minv_zoomin_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_minv_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_pair_pt_log_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_pair_pt_log_mu4_w_single_b_sig_sel[isign]);
    //     h_minv_pair_pt_log_mu4_mu4noL1_w_single_b_sig_sel[isign]->Divide(h_minv_pair_pt_log_mu4_w_single_b_sig_sel[isign]);

    //     h_Deta_2mu4_w_single_b_sig_sel[isign]->Divide(h_Deta_mu4_w_single_b_sig_sel[isign]);
    //     h_Deta_zoomin_2mu4_w_single_b_sig_sel[isign]->Divide(h_Deta_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_Dphi_2mu4_w_single_b_sig_sel[isign]->Divide(h_Dphi_mu4_w_single_b_sig_sel[isign]);
    //     h_Dphi_zoomin_2mu4_w_single_b_sig_sel[isign]->Divide(h_Dphi_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_DR_2mu4_w_single_b_sig_sel[isign]->Divide(h_DR_mu4_w_single_b_sig_sel[isign]);
    //     h_DR_zoomin_2mu4_w_single_b_sig_sel[isign]->Divide(h_DR_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_pt2nd_2mu4_w_single_b_sig_sel[isign]->Divide(h_pt2nd_mu4_w_single_b_sig_sel[isign]);
    //     h_pt2nd_vs_q_eta_2nd_2mu4_w_single_b_sig_sel[isign]->Divide(h_pt2nd_vs_q_eta_2nd_mu4_w_single_b_sig_sel[isign]);
    //     h_pair_eta_vs_pair_pT_2mu4_w_single_b_sig_sel[isign]->Divide(h_pair_eta_vs_pair_pT_mu4_w_single_b_sig_sel[isign]);
    //     h_Deta_Dphi_2mu4_w_single_b_sig_sel[isign]->Divide(h_Deta_Dphi_mu4_w_single_b_sig_sel[isign]);
    //     h_eta1_eta2_2mu4_w_single_b_sig_sel[isign]->Divide(h_eta1_eta2_mu4_w_single_b_sig_sel[isign]);
    //     h_eta_avg_Deta_2mu4_w_single_b_sig_sel[isign]->Divide(h_eta_avg_Deta_mu4_w_single_b_sig_sel[isign]);
    //     h_eta_avg_Dphi_2mu4_w_single_b_sig_sel[isign]->Divide(h_eta_avg_Dphi_mu4_w_single_b_sig_sel[isign]);
    //     h_minv_zoomin_2mu4_w_single_b_sig_sel[isign]->Divide(h_minv_zoomin_mu4_w_single_b_sig_sel[isign]);
    //     h_pair_pt_log_2mu4_w_single_b_sig_sel[isign]->Divide(h_pair_pt_log_mu4_w_single_b_sig_sel[isign]);
    //     h_minv_pair_pt_log_2mu4_w_single_b_sig_sel[isign]->Divide(h_minv_pair_pt_log_mu4_w_single_b_sig_sel[isign]);
    // }
}

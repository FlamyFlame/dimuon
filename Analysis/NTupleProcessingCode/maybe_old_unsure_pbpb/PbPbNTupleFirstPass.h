#ifndef __PbPbNTupleFirstPass_h__
#define __PbPbNTupleFirstPass_h__

#include "PbPbNTupleFirstPassBaseClass.h"

class PbPbNTupleFirstPass{
...
PbPbNTupleFirstPass::PbPbNTupleFirstPass(){
    if(mode != 3 && mode != 4){
...
void PbPbNTupleFirstPass::InitOutput(){

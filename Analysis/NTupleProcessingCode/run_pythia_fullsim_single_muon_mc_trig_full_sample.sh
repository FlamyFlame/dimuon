...
# Pythia pp24 fullsim FULL sample -- trigger propagation + single-muon tree, for the MC-based single-muon mu4 efficiency (mc_trigger_efficiency.md Step 1).
#
...
# Output: muon_pairs_pythia_fullsim_pp24_no_data_resonance_cuts_mc_trig_single_muon_full.root
#
# Usage: ./run_pythia_fullsim_single_muon_mc_trig_full_sample.sh

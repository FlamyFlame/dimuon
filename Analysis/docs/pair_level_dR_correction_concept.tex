...
The flat-region value of $R$ is systematically $> 1$ because the expectation value of the inverse weight is biased:
\begin{equation}
  E\!\left[\frac{1}{\varepsilon_{\text{pair}}^{\text{nc}}}\right] > \frac{1}{E[\varepsilon_{\text{pair}}^{\text{nc}}]}\,,
\end{equation}
by Jensen's inequality (since $1/x$ is convex). This offset depends on the spread of $\varepsilon_{\text{pair}}^{\text{nc}}$ across the event sample and is therefore $p_T$- and centrality-dependent.

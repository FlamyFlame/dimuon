...
void pythia_muon_pair_origin_categr(){ // mode = 1: unweighted; mode = 2: weighted
  ...
  // if (mode == 1){
  //   hist_names.clear();
  //   hist_names.push_back({{"h_unweighted_bb_both_from_b_ancestor_sp_sign1_near","h_unweighted_bb_both_from_b_ancestor_sp_sign1_away"},{"h_unweighted_bb_both_from_b_ancestor_sp_sign2_near","h_unweighted_bb_both_from_b_ancestor_sp_sign2_away"}});
  //   hist_names.push_back({{"h_unweighted_cc_both_from_c_ancestor_sp_sign1_near","h_unweighted_cc_both_from_c_ancestor_sp_sign1_away"},{"h_unweighted_cc_both_from_c_ancestor_sp_sign2_near","h_unweighted_cc_both_from_c_ancestor_sp_sign2_away"}});
  // }
  // else{
  hist_names.clear();
  hist_names.push_back({{"h_both_from_b_muon_pair_origin_categr_sign1_near","h_both_from_b_muon_pair_origin_categr_sign1_away"},{"h_both_from_b_muon_pair_origin_categr_sign2_near","h_both_from_b_muon_pair_origin_categr_sign2_away"}});
  hist_names.push_back({{"h_one_from_b_one_from_c_muon_pair_origin_categr_sign1_near","h_one_from_b_one_from_c_muon_pair_origin_categr_sign1_away"},{"h_one_from_b_one_from_c_muon_pair_origin_categr_sign2_near","h_one_from_b_one_from_c_muon_pair_origin_categr_sign2_away"}});
  hist_names.push_back({{"h_both_from_c_muon_pair_origin_categr_sign1_near","h_both_from_c_muon_pair_origin_categr_sign1_away"},{"h_both_from_c_muon_pair_origin_categr_sign2_near","h_both_from_c_muon_pair_origin_categr_sign2_away"}});
  // }

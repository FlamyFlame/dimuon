...
std::vector<std::string> origin_categories = {"_qq","_single_g","_qg","_gg", "_others", "_from_same_b"};
std::vector<std::string> origin_catg_labels = {"qq","single g","qg","gg","others","from same b"};
std::vector<Color_t> line_colors = {kBlue, kOrange, kGreen + 2, kRed, kViolet, kBlack};
std::vector<Color_t> fill_colors = {kBlue, kOrange, kGreen, kRed, kViolet, kYellow};
